#!/usr/bin/env python3
"""
run_in_container - Execute commands in running [redacted] containers
"""
import argparse
import json
import subprocess
...
def find_containers(name_filter: str = "[redacted]") -> List[Container]:
    """
...
def main():
    ...
    parser.add_argument(
        "--filter",
        default="[redacted]",
        help="Container name filter (default: [redacted])"
    )
    parser.add_argument(
        "--user",
