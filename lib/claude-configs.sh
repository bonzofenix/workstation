...
function main() {
  ...
  # Its failures fail this step (and `make`): a warning scrolled past above a
  # green "configured" line is how partial installs went unnoticed.
  if ! "$workstation_dir/bin/skills-bundle" install; then
